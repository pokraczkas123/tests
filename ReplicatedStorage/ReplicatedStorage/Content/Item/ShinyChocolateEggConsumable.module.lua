-- Decompiled game.ReplicatedStorage.Content.Item.ShinyChocolateEggConsumable
...
local v7 = {
    ["Id"] = script.Name,
    ["DisplayName"] = "Shiny Chocolate Egg",
    ["Rarity"] = v2.Rarity.Type.Legendary,
    ["Type"] = v2.Type.Consumable,
    ["Description"] = "Has a chance to spawn in Pro matches!"
}
local v8 = {}
local v9 = v3.get
local v10 = {
