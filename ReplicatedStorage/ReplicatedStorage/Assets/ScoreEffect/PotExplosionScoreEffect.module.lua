-- Decompiled game.ReplicatedStorage.Assets.ScoreEffect.PotExplosionScoreEffect
...
return function(p2)
    ...
    local v4 = script.Pot:Clone()
    v_u_1:AddItem(v4, 7)
    v4.CFrame = v3 * CFrame.new(0, 2, -3)
    v4.Parent = workspace
    local v5 = TweenInfo.new(2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
    v4.Transparency = 0
    v4.Size = Vector3.new(3.307, 3.151, 3.706)
    ...
    game:GetService("TweenService"):Create(v4, v5, {
        ["Size"] = Vector3.new(11.574, 11.029, 12.971),
        ["Transparency"] = 0
    }):Play()
    task.wait(1)
