-- Decompiled game.ReplicatedStorage.Assets.ScoreEffect.ChocolateSplashScoreEffect
...
return function(p2)
    ...
    local v10 = script["Choclate Explosion"]:Clone()
    v_u_1:AddItem(v10, 7)
    ...
    task.wait(0.2)
    local v12 = script.enable:Clone()
    v_u_1:AddItem(v12, 7)
    v12.CFrame = v3 * CFrame.new(0, -2.5, 0)
