-- Decompiled game.ReplicatedStorage.Assets.ScoreEffect.LeafExplosionScoreEffect
...
return function(p8, _, p9)
    ...
    v_u_4:Start()
    local v_u_10 = script:WaitForChild("LeafExplosion"):Clone()
    v_u_10.Parent = workspace.Effects
    p9:GiveTask(v_u_10)
    local v11 = v_u_10:WaitForChild("LeafExplosionFX")
